              ...
              <input type="hidden" name="product_img" value="<%=product.getProduct_img()%>">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputPassword1" placeholder="price" name = "price" value="<%=product.getPrice()%>">
                  </div>
                  <div class="form-group">
