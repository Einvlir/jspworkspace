 ...
 * Generated at: 2021-06-25 00:25:05 UTC
...
NewsDAO newsDAO = new MybatisNewsDAO(); 
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	News news = newsDAO.select(news_id);
      ...
      out.write("		render(){\r\n");
      out.write("			//반복문 등 처리 할 때..\r\n");
      out.write("			//return 영역 밖에서 원하는 태그를 구성한 후 완성된 태그를 return안에서 사용하면 됨..\r\n");
      out.write("			var tag = [];\r\n");
      out.write("			for(var i = 0 ; i < this.props.result.commentsList.length; i++){\r\n");
      out.write("				var obj = this.props.result.commentsList[i];\r\n");
      out.write("				tag.push(\r\n");
      out.write("					<div>\r\n");
      out.write("						<input type = \"text\" value={obj.msg} style={{width:\"75%\"}}/>\r\n");
      out.write("						<input type = \"text\" value={obj.cwriter} style={{width:\"15%\"}}/>\r\n");
      out.write("						<input type = \"text\" value={obj.cdate} style={{width:\"8%\"}}/>\r\n");
      out.write("					</div>\r\n");
      out.write("				);\r\n");
      out.write("			}\r\n");
      ...
      out.write("	\r\n");
      out.write("	var bt_list=$(\"input[type='button']\")[0];\r\n");
      out.write("	var bt_edit=$(\"input[type='button']\")[1];\r\n");
      out.write("	var bt_del=$(\"input[type='button']\")[2];\r\n");
      out.write("	\r\n");
      ...
      out.write("	var formdata = $(\"#form2\").serialize();\r\n");
      out.write("	\r\n");
      out.write("	$.ajax({\r\n");
      ...
      out.write("		success:function(result, status, xhr){\r\n");
      out.write("			\r\n");
      out.write("			console.log(result.commentsList.length);\r\n");
      out.write("			//printCommentsList3(result);\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("//댓글목록 출력하기\r\n");
      out.write("function printCommentsList(json){\r\n");
      out.write("	//기존의 commentsArea의 컨텐츠 초기화\r\n");
      out.write("	$(\"#commentsArea\").html(\"\");\r\n");
      out.write("	\r\n");
      out.write("	var tag = \"\";\r\n");
      out.write("	for(var i = 0; i < json.commentsList.length; i++){\r\n");
      out.write("		var comments = json.commentsList[i];\r\n");
      out.write("		tag += \"<div>\"\r\n");
      out.write("		tag += \"<input type = 'text' value = '\"+comments.msg+\"' style='width:75%' readonly>\" ;\r\n");
      out.write("		tag += \"<input type = 'text' value = '\"+comments.cwriter+\"' style='width:15%' readonly>\" ;\r\n");
      out.write("		tag += \"<input type = 'text' value = '\"+comments.cdate+\"' style='width:8%' readonly>\" ;\r\n");
      out.write("		tag += \"</div>\"\r\n");
      out.write("	}\r\n");
      out.write("	$(\"#commentsArea\").append(tag);\r\n");
      out.write("}\r\n");
      out.write("//출력대상이 되는 tag를 객체로 처리해보자\r\n");
      ...
      out.print(news.getNews_id());
      out.write("\">\r\n");
      out.write("		<input type=\"text\" name = \"msg\" placeholder=\"메시지\" style=\"width: 75%\">\r\n");
      out.write("		<input type=\"text\" name = \"cwriter\" placeholder=\"작성자\" style=\"width: 15%\">\r\n");
      out.write("	    <input type=\"button\" value=\"댓글등록\" style=\"width: 8%\" onClick=\"registComments()\">\r\n");
      out.write("	</form>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
